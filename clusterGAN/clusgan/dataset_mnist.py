# Use 80% of the full normal data as training data, use the rest 20% and all anomaly class data as test data
from torch.utils.data import Subset
from PIL import Image
from torchvision.datasets import MNIST
from clusgan.torchvision_datasets import TorchvisionDataset
...
class MNIST_Dataset(TorchvisionDataset):
    ...
    def __init__(self, root: str, normal_class=0):
        ...
        self.outlier_classes = tuple([normal_class])
