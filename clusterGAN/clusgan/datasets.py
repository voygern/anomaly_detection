...
def get_dataloader(dataset_name='mnist', data_dir='', batch_size=64, train_set=True, num_workers=1, shuffle=True):
...
def get_dataloader_class(class_=0, dataset_name='mnist', data_dir='', batch_size=64, train_set=True, num_workers=1):
